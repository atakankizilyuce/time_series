...
# 48 adımlı bir test veri setimiz olduğu için 48 girdik
...
alphas = np.arange(0.8, 1, 0.01) # bu kısımda 0.1 den 1 e kadar 0.10 artacak şeklinde de değerlendirilebilir
...
# mevsimsellik ve artık bileşenleri trendden bağımsız ise seri toplamsaldır değilse çarpımsaldır.
# çarpımsal modeller daha bağımlıdır.
